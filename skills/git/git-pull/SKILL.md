---
name: git-pull
description: "Program git pull: Fetch from and integrate with another repo or branch."
version: 1.0.0
...
---
    ...
    Fetch from and integrate with another repo or branch.

    ## When to use

    `git pull` is part of an everyday version-control workflow. Know exactly what
    it changes before you run it — some git operations rewrite history.

    ## Worked example

    ```bash
    git pull --help     # read the options first
    git pull ...        # then run it deliberately
    ```
