---
name: bash-nano
description: "Program the nano command: Simple, beginner-friendly terminal text editor."
version: 1.0.0
...
---
    ...
    Use `nano` when your task matches what it does best (see Overview). In a
...
```
    ...
    `nano` is a building block in a shell pipeline. Compose it with `|`, guard on
    ...
    ## Full reference (`nano --help` on this machine)
