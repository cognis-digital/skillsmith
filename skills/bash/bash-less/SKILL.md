---
name: bash-less
description: "Program the less command: Page through text a screen at a time, with search and navigation."
version: 1.0.0
...
---
    ...
    Page through text a screen at a time, with search and navigation.

    ## When to use

    Use `less` when your task matches what it does best (see Overview). In a
...
```
    ...
    `less` is a building block in a shell pipeline. Compose it with `|`, guard on
    ...
    ## Full reference (`less --help` on this machine)
...
SSUUMMMMAARRYY OOFF LLEESSSS CCOOMMMMAANNDDSS
 ...
 ---------------------------------------------------------------------------
  ...
  v                    Edit the current file with $VISUA
```
